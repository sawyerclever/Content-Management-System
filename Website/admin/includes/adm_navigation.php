        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu alert-dropdown">
                        ...
                        <li class="divider"></li>
                        <li><a href="alerts.php">View All</a></li>
                    </ul>
                </li>
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="categories.php"><i class="fa fa-fw fa-list"></i> Categories</a></li>
                    <li>
                    ...
                    <li><a href="settings.php"><i class="fa fa-fw fa-cogs"></i> Settings</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </nav>