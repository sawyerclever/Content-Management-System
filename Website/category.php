        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <?php
                    ...
                    $query = "SELECT * FROM posts WHERE post_cat_id = '$post_category' AND post_status = 'published' ORDER BY post_id DESC";
                    ...
                    if($published_count === 0) { ?>
                        <h2 class='text-center'>Sorry!<i class='fa fa-fw fa-frown-o'></i></h2>
                        <h3 class='text-center'>There are currently no posts in this category. Please check back soon!</h3>
                        <hr> <?php
                    }
                ?>
